...
def parse_args():    
    ...
    parser.add_argument('-b_test', type=int, default=1, help='batch size for dataloader')
    ...
    parser.add_argument('-sam_ckpt', default='./sam_vit_h.pt' , help='sam checkpoint address')
